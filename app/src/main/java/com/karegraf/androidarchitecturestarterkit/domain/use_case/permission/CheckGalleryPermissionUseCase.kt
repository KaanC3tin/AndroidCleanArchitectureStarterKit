...
class CheckGalleryPermissionUseCase @Inject constructor(private val repository: PermissionRepository)  {
    operator fun invoke(): PermissionStatus {
        return repository.checkPermission(AppPermissions.GALLERY)
    }
}