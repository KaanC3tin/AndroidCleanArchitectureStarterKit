...
class CheckLocationPermissionUseCase @Inject constructor(private val repository: PermissionRepository) {
    operator fun invoke(): PermissionStatus {
        return repository.checkPermission(AppPermissions.LOCATION)
    }
    }