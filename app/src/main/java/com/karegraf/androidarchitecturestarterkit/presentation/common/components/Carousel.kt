...
fun CarouselExample_MultiBrowse() {
    ...
    val items = remember {
        listOf(
            CarouselItem(0, R.drawable.ic_launcher_foreground, "cupcake"),
            CarouselItem(1, R.drawable.ic_launcher_background, "donut"),
            CarouselItem(2, R.drawable.ic_launcher_foreground, "eclair"),
            CarouselItem(3, R.drawable.ic_launcher_background, "froyo"),
            CarouselItem(4, R.drawable.ic_launcher_foreground, "gingerbread"),
        )
    }
